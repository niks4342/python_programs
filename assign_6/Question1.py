...
# That class contains one class variable as NoOfBooks which is initialise to 0.  There is one instance methods 
# of class as Display which displays name , Author and number of  books.  
...
class BookStore:
    ...
    def __init__(self,name,author):
        ...
        BookStore.NoBooks=self.NoBooks+1
        
    def Display(self):
       print(self.Name ,"by" ,self.Author,".","No of book :",BookStore.NoBooks)
